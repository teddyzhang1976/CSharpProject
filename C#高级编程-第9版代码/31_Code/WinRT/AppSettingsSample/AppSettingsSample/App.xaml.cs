...
namespace AppSettingsSample
{
  ...
  sealed partial class App : Application
  {
    ...
    {
      var command1 = new SettingsCommand("command1", "Command 1", new UICommandInvokedHandler(Command1));
      args.Request.ApplicationCommands.Add(command1);
      var command2 = new SettingsCommand("command2", "Command 2", new UICommandInvokedHandler(Command2));
      args.Request.ApplicationCommands.Add(command2);
    }

    private async void Command1(IUICommand command)
    {
      await Launcher.LaunchUriAsync(new Uri("http://www.cninnovation.com"));
    }
