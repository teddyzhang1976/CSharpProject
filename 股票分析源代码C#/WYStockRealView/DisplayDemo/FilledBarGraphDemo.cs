...
namespace ZedGraph.Demo
{
	...
	public class FilledBarGraphDemo : DemoBase
	{
											...
											"Filled Bar Graph Demo", DemoType.Bar, DemoType.Special )
		{
            ...
            //Stream imgStream = a.GetManifestResourceStream("WYStockRealView.ngc4414.jpg");
			Image image = Bitmap.FromFile(@"Resources/ngc4414.jpg");//FromStream( imgStream ) as Bitmap;
			...
			//Image image2 = Bitmap.FromStream( imgStream2 ) as Bitmap;
            	Image image2 = Bitmap.FromFile(@"Resources/ngc4261.gif");
			// create a brush with the image
