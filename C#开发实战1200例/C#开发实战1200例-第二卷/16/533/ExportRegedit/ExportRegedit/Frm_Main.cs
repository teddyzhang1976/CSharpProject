...
namespace ExportRegedit
{
    public partial class Frm_Main : Form
    {
        ...
        {
            saveFileDialog1.Filter = "reg文件(*.reg)|*.reg";
            saveFileDialog1.FileName = "backup.reg";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string pp = "regedit /e " + textBox1.Text;//设置备份注册表到指定目录的命令字符串
                myProcess.StandardInput.WriteLine(pp);//实现备份注册表
