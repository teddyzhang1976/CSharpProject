...
namespace MappedMemoryFiles
{
    class Program
    {
        ...
        {
            using (var mmFile = MemoryMappedFile.CreateFromFile(@"c:\users\bill\documents\visual studio 10\Projects\MappedMemoryFiles\MappedMemoryFiles\TextFile1.txt", System.IO.FileMode.Create, "fileHandle", 1024 * 1024))
            {
